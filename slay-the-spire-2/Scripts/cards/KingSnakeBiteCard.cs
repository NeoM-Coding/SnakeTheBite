...
public class KingSnakeBiteCard : SnakeTheBiteCardModel
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await PowerCmd.Apply<KingSnakeBitePower>(new ThrowingPlayerChoiceContext(), Owner.Creature, DynamicVars["KingSnakeBitePower"].BaseValue, Owner.Creature, this, false);
    }
